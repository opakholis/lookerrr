...
export const Job = ({ data }) => {
  return (
    <div className="break-inside-avoid">
      <Link
        to={`/jobs/${data.id}`}
        className="group mb-4 flex transform flex-col justify-between rounded-xl border border-zinc-100 bg-white p-4 shadow-lg shadow-zinc-100 transition duration-200 hover:scale-105 hover:border-indigo-400 hover:shadow-lg lg:hover:scale-110"
      >
        <div>
